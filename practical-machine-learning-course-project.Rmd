...
Going forward, we will use the columns that have values for most of the rows, to predict the "classe" variable, as generated below. 
...
Since the prediction accuracy of about 96% reasonable, let us try to make a prediction on the test data set and compare the accuracy obtained on the test dataset. 
```{r}
